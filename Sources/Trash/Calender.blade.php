    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{asset('admin')}}/calendar.html" class="nav-link active">
...
<!-- Bootstrap -->
<script src="{{asset('admin')}}/Pages/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- jQuery UI -->
<script src="{{asset('admin')}}/Pages/plugins/jquery-ui/jquery-ui.min.js"></script>
<!-- AdminLTE App -->
<script src="{{asset('admin')}}/Pages/dist/js/adminlte.min.js"></script>
<!-- fullCalendar 2.2.5 -->
<script src="{{asset('admin')}}/Pages/plugins/moment/moment.min.js"></script>
<script src="{{asset('admin')}}/Pages/plugins/fullcalendar/main.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{asset('admin')}}/Pages/dist/js/demo.js"></script>
